<header class="b-header js-header">
    <div class="b-header__wrapper">
            ...
            <div class="b-popup__container js-custom-scrollbar">
                <div class="b-popup__content js-modal-content">
                    <div class="b-notification">
                        <div class="b-notification__close js-menu-close"></div>
                        <div class="b-notification__wrapper">
                            <div class="b-notification__item b-notification__item--viewed">
                                <div class="b-notification__item-title">Новое достижение</div>
                                <div class="b-notification__item-description">Вы получили достижение ОЛДФАГ IV за 4 года
                                    после регистрации
                                </div>
                                <a class="b-notification__item-btn"
                                   href="/profile/achievements?achievement=4">Показать</a>
                            </div>
                            <div class="b-notification__item b-notification__item--viewed">
                                <div class="b-notification__item-title">Как вам игра?</div>
                                <div class="b-notification__item-description">Почувствуйте себя немного критиком —
                                    оцените
                                    LEGO Marvel Super Heroes
                                </div>
                                <a class="b-notification__item-btn"
                                   href="https://gabestore.ru/game/lego-marvel-super-heroes">Перейти к игре</a>
                            </div>
                            <div class="b-notification__item b-notification__item--viewed">
                                <div class="b-notification__item-title">Level Up</div>
                                <div class="b-notification__item-description">Вы повысили свой уровень до 7 . Теперь в
                                    общем
                                    рейтинге Вы 28 385 среди 299 627
                                </div>
                                <a class="b-notification__item-btn" href="/profile">Показать</a>
                            </div>
                            <div class="b-notification__item b-notification__item--viewed">
                                <div class="b-notification__item-title">Новое достижение</div>
                                <div class="b-notification__item-description">Вы получили достижение ПК-БОЯРИН II за 15
                                    покупок
                                </div>
                                <a class="b-notification__item-btn"
                                   href="/profile/achievements?achievement=6">Показать</a>
                            </div>
                            <a href="/profile/notifications">
                                <div class="btn btn--primary"> Все уведомления</div>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="b-popup__content js-modal-content">
                    ...
                    <div class="b-menu__wrapper js-accordeon-container" data-mobile="true">
                        <ul class="b-menu__list b-menu__list--main b-menu__col">
                            <li class="b-menu__list-item b-menu__list-item--display--mobile">
                                <a href="/catalog">все игры</a>
                            </li>
                            <li class="b-menu__list-item">
                                <a href="/top">лидеры продаж</a>
                            </li>
                            <li class="b-menu__list-item">
                                <a href="/newgames">новинки</a>
                            </li>
                            <li class="b-menu__list-item">
                                <a href="/preorders">предзаказы</a>
                            </li>
                            <li class="b-menu__list-item">
                        ...
                        <div class="b-menu__accordeon b-menu__col">
                            ...
                            <ul class="b-menu__accordeon-list">
                                ...
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=22">Ролевые</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=2">Приключения</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=24">Стратегии</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=23">Симуляторы</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=25">Онлайн</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=705">Инди</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=27">Спорт</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=706">Казуальные</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/catalog?ProductFilter%5Bgenre%5D%5B%5D=1467">Гонки</a>
                                </li>
                                <ul class="b-menu__list b-menu__list-sub">
                                    <li class="b-menu__list-item">
                                        <a href="/catalog">Все игры — 2699</a>
                                    </li>
                                </ul>
                            </ul>
                        </div>
                        <div class="b-menu__accordeon b-menu__col">
                            ...
                            <ul class="b-menu__accordeon-list">
                                ...
                                <li class="b-menu__accordeon-item">
                                    <a href="/publishers/BANDAI-NAMCO">BANDAI NAMCO</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/publishers/Bethesda-Softworks">Bethesda Softworks</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/publishers/Capcom">Capcom</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/publishers/Electronic-Arts">Electronic Arts</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/publishers/Paradox-Interactive">Paradox Interactive</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/publishers/SEGA">SEGA</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/publishers/Ubisoft">Ubisoft</a>
                                </li>
                                <ul class="b-menu__list b-menu__list-sub">
                                    <li class="b-menu__list-item">
                                        <a href="/publishers">Все издатели — 189</a>
                                    </li>
                                </ul>
                            </ul>
                        </div>
                        <div class="b-menu__accordeon b-menu__col">
                            ...
                            <ul class="b-menu__accordeon-list">
                                ...
                                <li class="b-menu__accordeon-item">
                                    <a href="/developers/Hangar-13"> Hangar 13</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/developers/Team17-Digital"> Team17 Digital</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/developers/Creative-Assembly">Creative Assembly</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/developers/DICE">DICE</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/developers/Firaxis">Firaxis</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/developers/Remedy-Entertainment">Remedy Entertainment</a>
                                </li>
                                <li class="b-menu__accordeon-item">
                                    <a href="/developers/Respawn-Entertainment">Respawn Entertainment</a>
                                </li>
                                <ul class="b-menu__list b-menu__list-sub">
                                    <li class="b-menu__list-item">
                                        <a href="/developers">Все разработчики — 887</a>
                                    </li>
                                </ul>
                            </ul>
                        </div>
            ...
            <div class="b-popup__container js-custom-scrollbar">
                <div class="b-popup__content js-modal-content">
                    <div class="b-comment-change-popup js-comment-change-popup">
                        <button class="b-comment-change-popup__item js-comment-edit" type="button">Редактировать
                        </button>
        ...
        <div class="b-preloader js-preloader" hidden="hidden">
            <img src="{{ asset('images/preloader.svg') }}" alt="Gabestore">
        </div>
    </div>
</header>
